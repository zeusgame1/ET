...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetController_0);
            args = new Type[]{typeof(System.String)};
            ...
            app.RegisterCLRMethodRedirection(method, get_numChildren_4);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("GetChildAt", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetChildAt_5);


        }


        static StackObject* GetController_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_numChildren_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* GetChildAt_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
