...
{
    unsafe class ETCold_Define_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(ETCold.Define);
        ...
        {
            ETCold.Define.IsILRuntime = (System.Boolean)v;
        }
        ...
        static StackObject* AssignFromStack_IsILRuntime_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ETCold.Define.IsILRuntime = @IsILRuntime;
