...
{
    unsafe class ETCold_AService_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(ETCold.AService);
        ...
        static StackObject* RemoveChannel_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETCold.AService instance_of_this_method = (ETCold.AService)typeof(ETCold.AService).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* AssignFromStack_ErrorCallback_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((ETCold.AService)o).ErrorCallback = @ErrorCallback;
            return ptr_of_this_method;
        }

        static object get_ReadCallback_1(ref object o)
        {
            return ((ETCold.AService)o).ReadCallback;
        }

        static StackObject* CopyToStack_ReadCallback_1(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((ETCold.AService)o).ReadCallback;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_ReadCallback_1(ref object o, object v)
        {
            ((ETCold.AService)o).ReadCallback = (System.Action<System.Int64, System.IO.MemoryStream>)v;
        }
        ...
        static StackObject* AssignFromStack_ReadCallback_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((ETCold.AService)o).ReadCallback = @ReadCallback;
            return ptr_of_this_method;
        }

        static object get_AcceptCallback_2(ref object o)
        {
            return ((ETCold.AService)o).AcceptCallback;
        }

        static StackObject* CopyToStack_AcceptCallback_2(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((ETCold.AService)o).AcceptCallback;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_AcceptCallback_2(ref object o, object v)
        {
            ((ETCold.AService)o).AcceptCallback = (System.Action<System.Int64, System.Net.IPEndPoint>)v;
        }
        ...
        static StackObject* AssignFromStack_AcceptCallback_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((ETCold.AService)o).AcceptCallback = @AcceptCallback;
            return ptr_of_this_method;
        }
