...
{
    unsafe class ETCold_ByteHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETCold.ByteHelper);
            args = new Type[]{typeof(System.Byte[]), typeof(System.String)};
            method = type.GetMethod("ToHex", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToHex_0);
            args = new Type[]{typeof(System.Byte[]), typeof(System.Int32), typeof(System.Int32)};
            method = type.GetMethod("ToStr", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToStr_1);
        ...
        static StackObject* ToHex_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETCold.ByteHelper.ToHex(@bytes, @format);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* ToStr_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = ETCold.ByteHelper.ToStr(@bytes, @index, @count);
        ...
        static StackObject* WriteTo_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETCold.ByteHelper.WriteTo(@bytes, @offset, @num);
