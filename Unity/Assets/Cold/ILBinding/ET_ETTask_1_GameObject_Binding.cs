...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_ETTask_1_GameObject_Binding
    {
        ...
        static StackObject* SetResult_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<UnityEngine.GameObject> instance_of_this_method = (ET.ETTask<UnityEngine.GameObject>)typeof(ET.ETTask<UnityEngine.GameObject>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
