...
{
    unsafe class ETCold_ListComponent_1_Vector3_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETCold.ListComponent<UnityEngine.Vector3>);
            args = new Type[]{};
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETCold.ListComponent<UnityEngine.Vector3>.Create();
        ...
        static StackObject* get_List_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETCold.ListComponent<UnityEngine.Vector3> instance_of_this_method = (ETCold.ListComponent<UnityEngine.Vector3>)typeof(ETCold.ListComponent<UnityEngine.Vector3>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
