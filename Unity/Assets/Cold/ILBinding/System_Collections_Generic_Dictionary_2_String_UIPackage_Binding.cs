...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_Dictionary_2_String_UIPackage_Binding
    {
        ...
        static StackObject* TryGetValue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.UIPackage @value = (FairyGUI.UIPackage)typeof(FairyGUI.UIPackage).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
            ...
            System.Collections.Generic.Dictionary<System.String, FairyGUI.UIPackage> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, FairyGUI.UIPackage>)typeof(System.Collections.Generic.Dictionary<System.String, FairyGUI.UIPackage>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Add_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            FairyGUI.UIPackage @value = (FairyGUI.UIPackage)typeof(FairyGUI.UIPackage).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
