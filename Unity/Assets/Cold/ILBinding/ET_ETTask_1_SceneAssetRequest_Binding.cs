...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_ETTask_1_SceneAssetRequest_Binding
    {
        ...
        static StackObject* SetResult_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<libx.SceneAssetRequest> instance_of_this_method = (ET.ETTask<libx.SceneAssetRequest>)typeof(ET.ETTask<libx.SceneAssetRequest>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
