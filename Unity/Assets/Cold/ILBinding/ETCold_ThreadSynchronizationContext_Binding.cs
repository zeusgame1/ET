...
{
    unsafe class ETCold_ThreadSynchronizationContext_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETCold.ThreadSynchronizationContext);
            args = new Type[]{};
        ...
        static StackObject* get_Instance_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETCold.ThreadSynchronizationContext.Instance;
        ...
        static StackObject* Update_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETCold.ThreadSynchronizationContext instance_of_this_method = (ETCold.ThreadSynchronizationContext)typeof(ETCold.ThreadSynchronizationContext).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
